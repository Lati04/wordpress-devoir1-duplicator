...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'migration_wp_01_267776_9db44ef1c7c9082d4381_20230713110938_archive.zip';
        const ARCHIVE_SIZE       = '47652077';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '9db44ef-13110938';
        const SECONDARY_PACKAGE_HASH = '5cf7b85-13110938';
        const VERSION            = '1.5.5';
